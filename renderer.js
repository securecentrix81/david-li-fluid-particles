...
var Renderer = (function () {
    ...
    the depth is simply the z in view space
    */
    ...
    function Renderer(canvas, wgl, gridDimensions, onLoaded) {
        ...
        this.lightProjectionMatrix = Utilities.makeOrthographicMatrix(
            new Float32Array(16),
            -gridDimensions[0] / 2, gridDimensions[0] / 2,
            -gridDimensions[2] / 2, gridDimensions[2] / 2,
            -gridDimensions[1] / 2, gridDimensions[1] / 2
        );
    ...
    Renderer.prototype.onResize = function () {
        ...
        wgl.rebuildTexture(this.renderingTexture, wgl.RGBA, wgl.FLOAT, this.canvas.width, this.canvas.height, null, wgl.CLAMP_TO_EDGE, wgl.CLAMP_TO_EDGE, wgl.LINEAR, wgl.LINEAR);
    ...
    Renderer.prototype.draw = function (simulator, projectionMatrix, viewMatrix) {
        ...
        // Keep simulator updated with the current render orientation.
        // If simulate() happens before draw() in your app loop, the simulator will use the previous frame's viewMatrix.
        // To eliminate even that one-frame delay, also pass viewMatrix as the 5th argument to simulator.simulate(...).
        if (simulator && typeof simulator.setViewMatrix === 'function') {
            simulator.setViewMatrix(viewMatrix);
        }
